...
public class ServerRestaurantActivity extends AppCompatActivity implements
    ...
    private ParseGeoPoint m_geopoint;
...
//    protected Button m_findBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_server_restaurant);

        ShortcutBadger.with(getApplicationContext()).remove();
        MyCustomReceiver.badgeCount = 0;

        mProgressBar = (ProgressBar) findViewById(R.id.sr_progressBar);

        ParseUser currUser = ParseUser.getCurrentUser();
        String restaurantName = currUser.getString("restaurant_name");
        m_geopoint = currUser.getParseGeoPoint("location");

        ImageButton m_backBtn = (ImageButton) findViewById(R.id.llBack);
        m_backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ServerRestaurantActivity.this, ServerProfileActivity.class);
                ServerRestaurantActivity.this.finish();
                startActivity(i);
            }
        });

        m_numberTextView = (TextView) findViewById(R.id.sr_restaurantText);
//        m_findBtn = (Button)findViewById(R.id.sr_findbutton);
        m_numberTextView.setText("You are serving at " + restaurantName + ".");
        m_restaurantTitle = restaurantName;
...
//        });
        ...
        mapFragment = ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.sr_map));
    ...
    */
    ...
    public void onConnected(Bundle dataBundle) {
        ...
        if (location != null) {
            // Toast.makeText(this, "GPS location was found!", Toast.LENGTH_LONG).show();
    ...
    private String downloadUrl(String strUrl) throws IOException{
        ...
        try{
            ...
            Toast.makeText(ServerRestaurantActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }finally{
            iStream.close();
    ...
    public boolean onMarkerClick(final Marker marker) {
        ...
        m_geopoint.setLatitude(m_restaurantLatLang.latitude);
        m_geopoint.setLongitude(m_restaurantLatLang.longitude);
    ...
    public void Save(final View view){
        // Save in the _User table
        ParseUser currUser = ParseUser.getCurrentUser();
        currUser.put("location", m_geopoint);
        currUser.put("restaurant_name", m_restaurantTitle);
        ArrayList<String> emptyList = new ArrayList<String>();
        currUser.put("table_numbers", emptyList);

        //mProgressBar.setVisibility(view.VISIBLE);
        final ACProgressFlower dialog = new ACProgressFlower.Builder(ServerRestaurantActivity.this)
        ...
        currUser.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                if (e == null) {
                    //Saved successfully
                    Toast.makeText(ServerRestaurantActivity.this, "Saved successfully", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(ServerRestaurantActivity.this, ServerProfileActivity.class);
                    sendLocalNotification();
                    ServerRestaurantActivity.this.finish();
                    startActivity(i);
                } else {
                    Toast.makeText(ServerRestaurantActivity.this, "Failed to save", Toast.LENGTH_LONG).show();
    ...
    private void sendLocalNotification(){
        final Intent intent = new Intent("clear_notification");
        intent.putExtra("aKey", "clear_notification");
